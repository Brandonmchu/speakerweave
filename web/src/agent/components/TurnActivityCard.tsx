    ...
    <div className="mt-3 overflow-hidden rounded-xl border border-border bg-card shadow-soft">
        ...
        {visible.map((item, index) => {
          ...
          return (
            <button
              ...
              className="flex w-full items-center gap-2.5 px-3 py-2.5 text-left transition-colors hover:bg-hover disabled:cursor-default"
            >
      ...
      {activity.length > 4 && (
        <button
          ...
          className="w-full border-t border-border px-3 py-2 text-left text-[11px] font-medium text-primary hover:bg-primary-subtle/50"
        >
